...
public class ProxyExample {
	...
	public static void main(final String[] args) throws AmeeException {
		...
		// Configure proxy
		final String proxy_host = "proxy.mydomain.com";
		final Integer proxy_port = 3128;
		final String proxy_username = "proxy-username";
		final String proxy_password = "proxy-password";
		AmeeContext.getInstance().getClient().getHostConfiguration()
