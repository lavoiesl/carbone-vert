...
public class AmeeProfileItem extends AmeeItem implements Serializable,
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6230015368217724868L;
	...
	public AmeeProfileItem(final AmeeObjectReference ref) {
		super(ref);
	}

	public AmeeProfileItem(final String path, final AmeeObjectType objectType) {
		super(path, objectType);
	}

	public void populate(final AmeeProfileItem copy) {
		super.populate(copy);
	...
	public AmeeObject getCopy() {
		final AmeeProfileItem copy = new AmeeProfileItem();
		populate(copy);
		return copy;
	}
	...
	public AmeeDataItem getDataItem() throws AmeeException {
		...
		if (getDataItemRef() != null) {
			dataItem = (AmeeDataItem) AmeeObjectFactory.getInstance()
					.getObject(getDataItemRef());
		}
		return dataItem;
	}
	...
	public void setParentRef() {
		setParentRef(new AmeeObjectReference(getObjectReference()
				.getParentUri(), AmeeObjectType.PROFILE_CATEGORY));
	}
	...
	public void setDataItemRef(final AmeeObjectReference dataItemRef) {
		if (dataItemRef != null) {
	...
	// TODO - V1
	public void setValidFrom(final String validFromStr) {
		setValidFrom(getFullDate(validFromStr));
	}

	// TODO - V1
	public void setValidFrom() {
		final Calendar validFromCal = Calendar.getInstance();
		final int year = validFromCal.get(Calendar.YEAR);
		final int month = validFromCal.get(Calendar.MONTH);
		validFromCal.clear();
	...
	// TODO - V2
	public void setStartDate(final String startDateStr)
	...
	// TODO - V2
	public void setEndDate(final String endDateStr)
			throws IllegalArgumentException {
	...
	public void addReturnValue(final ReturnValue value) {
	...
	public ReturnValue getDefaultReturnValue() throws AmeeException {
		for (final ReturnValue value : getReturnValues()) {
	...
	public void addNote(final ReturnNote note) {
