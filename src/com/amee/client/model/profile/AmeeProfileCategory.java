...
public class AmeeProfileCategory extends AmeeCategory implements Serializable {
	...
	public AmeeProfileCategory(final AmeeObjectReference ref) {
		super(ref);
	}

	public AmeeProfileCategory(final String path,
			final AmeeObjectType objectType) {
		super(path, objectType);
	}

	public void populate(final AmeeProfileCategory copy) {
		super.populate(copy);
	...
	public AmeeObject getCopy() {
		final AmeeProfileCategory copy = new AmeeProfileCategory();
		populate(copy);
		return copy;
	}
	...
	public void setParentRef() {
		final String parentUri = getObjectReference().getParentUri();
		if (parentUri.equals(getProfileRef().getUri())) {
			setParentRef(getProfileRef());
		} else {
			setParentRef(new AmeeObjectReference(parentUri,
	...
	public List<AmeeProfileCategory> getProfileCategories()
			throws AmeeException {
		final List<AmeeProfileCategory> profileCategories = new ArrayList<AmeeProfileCategory>();
	...
	public List<AmeeProfileItem> getProfileItems() throws AmeeException {
		final List<AmeeProfileItem> profileItems = new ArrayList<AmeeProfileItem>();
	 ...
	 * 
	 * @param dataItemUid
	 *            the UID of the AmeeDataItem to base the new AmeeProfileItem on
	 * @return the new AmeeProfileItem
	 * @throws AmeeException
	 */
	public AmeeProfileItem addProfileItem(final String dataItemUid)
			throws AmeeException {
	 ...
	 * 
	 * @param dataItem
	 *            the AmeeDataItem to base the new AmeeProfileItem on
	 * @return the new AmeeProfileItem
	 * @throws AmeeException
	 */
	public AmeeProfileItem addProfileItem(final AmeeDataItem dataItem)
			throws AmeeException {
	...
	public void setProfileRef(final AmeeObjectReference profileRef) {
		if (profileRef != null) {
	...
	public void setProfileRef() {
		final String ref = getObjectReference().getUriFirstTwoParts();
		if (ref != null) {
	...
	public void setDataCategoryRef(final AmeeObjectReference dataCategoryRef) {
		if (dataCategoryRef != null) {
	...
	public void setDataCategoryRef() {
		setProfileRef(new AmeeObjectReference("/data/"
				+ getObjectReference().getUriExceptFirstTwoParts(),
	...
	public void setAmount(final String amount) {
		if (amount != null) {
			...
			newAmount = newAmount.setScale(AmeeConstants.SCALE,
					AmeeConstants.ROUNDING_MODE);
